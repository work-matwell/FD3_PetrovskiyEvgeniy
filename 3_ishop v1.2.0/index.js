...
let ShopTable = React.createClass({ 
  ...
  propTypes:{
    tableHeader: React.PropTypes.arrayOf(React.PropTypes.string.isRequired),
  ...
  render: function() {
    ...
    this.props.goods.forEach(value => {
      let tableRow = React.DOM.tr({key: value.productCode, className: 'TableRow',  onClick: this.selectRow,},
